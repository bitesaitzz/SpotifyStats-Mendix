...
/**
 * Returns the entry related to the given key. Provide the entity type so that the returned object is of the right type. If the entity type does not match the entity type given at creation of the map, this will throw a runtime error.
 */
public class JAVA_Hashmap_GetEntry extends UserAction<IMendixObject>
{
	...
	public IMendixObject executeAction() throws Exception
	{
		...
		return map.getMap().get(this.Key);
		// END USER CODE
	}
