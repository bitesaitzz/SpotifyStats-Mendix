...
/**
 * Deletes the map from memory. Do NOT use the map object afterwards!
 */
public class JAVA_Hashmap_Delete extends UserAction<java.lang.Void>
{
	...
	{
		// BEGIN USER CODE
		MxHashMapHelper.removeHashMap(this.Map.getMendixObject());
		this.Map.delete();
		return null;
		// END USER CODE
	}
