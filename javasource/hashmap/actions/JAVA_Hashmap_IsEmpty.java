...
/**
 * Checks whether the map contains no key-value mappings
 */
public class JAVA_Hashmap_IsEmpty extends UserAction<java.lang.Boolean>
{
	...
	{
		// BEGIN USER CODE
		return MxHashMapHelper.getHashMap(this.Map.getMendixObject()).getMap().isEmpty();
		// END USER CODE
	}
