...
/**
 * Clears the hash map. Does not return its values
 */
public class JAVA_Hashmap_Clear extends UserAction<java.lang.Void>
{
	...
	{
		// BEGIN USER CODE
		MxHashMapHelper.getHashMap(this.Map.getMendixObject()).getMap().clear();
		return null;
		// END USER CODE
	}
