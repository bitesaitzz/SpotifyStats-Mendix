...
/**
 * Creates a new LinkedHashMap on ThreadLocal and returns its handle string.
 * You can use other actions by returned handle string.
 * 
 */
public class CreateLinkedHashMap extends UserAction<java.lang.String>
{
	private final java.lang.Boolean AccessOrder;

	public CreateLinkedHashMap(
		IContext context,
	...
	public java.lang.String executeAction() throws Exception
	{
		...
		HashMapUtil.putLocalContentMap(handle, new LinkedHashMap<String, IMendixObject>(16, (float)0.75, this.AccessOrder));
		return handle;
		// END USER CODE
	}
