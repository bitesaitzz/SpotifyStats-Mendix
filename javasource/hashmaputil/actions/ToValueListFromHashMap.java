...
/**
 * Get value list of the hashmap that specified by the handle.
 * You can get handle by CreateHashMap action.
 * 
 */
public class ToValueListFromHashMap extends UserAction<java.util.List<IMendixObject>>
{
	private final java.lang.String Handle;
	private final java.lang.String ValueType;

	public ToValueListFromHashMap(
		IContext context,
	...
	public java.util.List<IMendixObject> executeAction() throws Exception
	{
		...
		if (myMap == null) {
			...
			java.util.List<IMendixObject> list = new java.util.ArrayList<IMendixObject>(myMap.values());
			return list;
		}
		// END USER CODE
	}
